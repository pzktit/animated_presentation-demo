# manim-slides render slide03.py ConvertExample
# manim-slides convert ConvertExample ConvertExample.html
# right-click ConvertExample.html and open in LiveServer
